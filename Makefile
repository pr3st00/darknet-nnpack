...
FOLLOWEROBJA=captcha.o lsd.o super.o art.o tag.o cifar.o go.o rnn.o segmenter.o regressor.o classifier.o coco.o yolo.o detector.o nightmare.o follower.o
...
FOLLOWEROBJ = $(addprefix $(OBJDIR), $(FOLLOWEROBJA))
